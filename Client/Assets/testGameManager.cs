...
public class testGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // floor
        world.Add(new Box(new BEPUutilities.Vector3(0, -0.5f, 0), 30, 1, 30));
        ...
        ac.cc = new BEPUphysics.Character.CharacterController();
        world.Add(ac.cc);
        ...
        var vertices = new BEPUutilities.Vector3[]
{
        ...
        var stair = new BEPUphysics.BroadPhaseEntries.StaticMesh(vertices, indices);
        world.Add(stair);
